...
################################################################
# This is a generated script based on design: Zynq7000_LaneCommanding
#
...
proc create_root_design { parentCell } {
  ...
  set DRDY_A1 [ create_bd_port -dir I -from 0 -to 0 DRDY_A1 ]
  set DRDY_A2 [ create_bd_port -dir I -from 0 -to 0 DRDY_A2 ]
  set DataEnable_GPIO [ create_bd_port -dir O -from 12 -to 0 DataEnable_GPIO ]
  #set LED11_IN [ create_bd_port -dir I LED11_IN ]
  #set LED11_OUT [ create_bd_port -dir O LED11_OUT ]
  #set LED12_IN [ create_bd_port -dir I LED12_IN ]
  #set LED12_OUT [ create_bd_port -dir O LED12_OUT ]
  ...
  set SPI_A_CLK [ create_bd_port -dir O SPI_A_CLK ]
  set SPI_A_CS [ create_bd_port -dir O -from 3 -to 0 SPI_A_CS ]
  set SPI_A_MISO [ create_bd_port -dir I SPI_A_MISO ]
  set SPI_A_MOSI [ create_bd_port -dir O SPI_A_MOSI ]
  set SPI_FLASH_A_CLK [ create_bd_port -dir O SPI_FLASH_A_CLK ]
  set SPI_FLASH_A_CS [ create_bd_port -dir O -from 2 -to 0 SPI_FLASH_A_CS ]
  set SPI_FLASH_A_DQ0 [ create_bd_port -dir O SPI_FLASH_A_DQ0 ]
  set SPI_FLASH_A_DQ1 [ create_bd_port -dir I SPI_FLASH_A_DQ1 ]
  set SPI_FLASH_A_DQ2 [ create_bd_port -dir O SPI_FLASH_A_DQ2 ]
  set SPI_FLASH_A_DQ3 [ create_bd_port -dir I SPI_FLASH_A_DQ3 ]
  ...
  set UART_A_RX [ create_bd_port -dir I UART_A_RX ]
  set UART_A_TX [ create_bd_port -dir O UART_A_TX ]
  set ext_spi_clk_o [ create_bd_port -dir O ext_spi_clk_o ]

  # Create instance: DRDY_A_GPIO, and set properties
  set DRDY_A_GPIO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DRDY_A_GPIO ]
  ...
  # Create instance: GPIO_DataEnable, and set properties
  set GPIO_DataEnable [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 GPIO_DataEnable ]
  set_property -dict [ list \
  ...
  #set block_name LED_Driver
  #set block_cell_name LED_Driver
  #if { [catch {set LED_Driver [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  #   catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  #   return 1
  # } elseif { $LED_Driver eq "" } {
  #   catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  #   return 1
  # }
  
  # Create instance: SPI_A, and set properties
  set SPI_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 SPI_A ]
  set_property -dict [ list \
  ...
  # Create instance: SPI_FLASH_A, and set properties
  set SPI_FLASH_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 SPI_FLASH_A ]
  set_property -dict [ list \
   CONFIG.C_FIFO_DEPTH {256} \
  ...
  set_property -dict [ list \
   CONFIG.C_EXTERNAL_XIN_CLK_HZ {14745600} \
   CONFIG.C_EXTERNAL_XIN_CLK_HZ_d {14.745600} \
  ...
  # Create instance: UART_A, and set properties
  set UART_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 UART_A ]
  set_property -dict [ list \
   CONFIG.C_EXTERNAL_XIN_CLK_HZ {14745600} \
   CONFIG.C_EXTERNAL_XIN_CLK_HZ_d {14.745600} \
   CONFIG.C_HAS_EXTERNAL_XIN {1} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {2.000000} \
   ...
   CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR0 {250} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins SPI_FLASH_A/AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins SPI_A/AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins DRDY_A_GPIO/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins UART_A/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins UART_3/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins UART_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins UART_5/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins UART_8/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins GPIO_DataEnable/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net DRDY_A_GPIO_ip2intc_irpt [get_bd_pins DRDY_A_GPIO/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net GPIO_DataEnable_gpio_io_o [get_bd_ports DataEnable_GPIO] [get_bd_pins GPIO_DataEnable/gpio_io_o]
  #connect_bd_net -net LED11_i_0_1 [get_bd_ports LED11_IN] [get_bd_pins LED_Driver/LED11_i]
  #connect_bd_net -net LED12_i_0_1 [get_bd_ports LED12_IN] [get_bd_pins LED_Driver/LED12_i]
  #connect_bd_net -net LED_Driver_LED11_o [get_bd_ports LED11_OUT] [get_bd_pins LED_Driver/LED11_o]
  #connect_bd_net -net LED_Driver_LED12_o [get_bd_ports LED12_OUT] [get_bd_pins LED_Driver/LED12_o]
  ...
  connect_bd_net -net SPI_A_ip2intc_irpt [get_bd_pins SPI_A/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net SPI_A_sck_o [get_bd_ports SPI_A_CLK] [get_bd_pins SPI_A/sck_o]
  connect_bd_net -net SPI_FLASH_A_ip2intc_irpt [get_bd_pins SPI_FLASH_A/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net SPI_FLASH_io0_o [get_bd_ports SPI_FLASH_A_DQ0] [get_bd_pins SPI_FLASH_A/io0_o]
  connect_bd_net -net SPI_FLASH_io2_o [get_bd_ports SPI_FLASH_A_DQ2] [get_bd_pins SPI_FLASH_A/io2_o]
  connect_bd_net -net SPI_FLASH_sck_o [get_bd_ports SPI_FLASH_A_CLK] [get_bd_pins SPI_FLASH_A/sck_o]
  connect_bd_net -net SPI_FLASH_ss_o [get_bd_ports SPI_FLASH_A_CS] [get_bd_pins SPI_FLASH_A/ss_o]
  connect_bd_net -net UART_3_ip2intc_irpt [get_bd_pins UART_3/ip2intc_irpt] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net UART_3_sout [get_bd_ports UART_3_TX] [get_bd_pins UART_3/sout]
  connect_bd_net -net UART_4_ip2intc_irpt [get_bd_pins UART_4/ip2intc_irpt] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net UART_4_sout [get_bd_ports UART_4_TX] [get_bd_pins UART_4/sout]
  connect_bd_net -net UART_5_ip2intc_irpt [get_bd_pins UART_5/ip2intc_irpt] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net UART_5_sout [get_bd_ports UART_5_TX] [get_bd_pins UART_5/sout]
  connect_bd_net -net UART_6_ip2intc_irpt [get_bd_pins UART_6/ip2intc_irpt] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net UART_6_sout [get_bd_ports UART_6_TX] [get_bd_pins UART_6/sout]
  connect_bd_net -net UART_7_ip2intc_irpt [get_bd_pins UART_7/ip2intc_irpt] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net UART_7_sout [get_bd_ports UART_7_TX] [get_bd_pins UART_7/sout]
  connect_bd_net -net UART_8_ip2intc_irpt [get_bd_pins UART_8/ip2intc_irpt] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net UART_8_sout [get_bd_ports UART_8_TX] [get_bd_pins UART_8/sout]
  connect_bd_net -net UART_A_ip2intc_irpt [get_bd_pins UART_A/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net UART_A_sout [get_bd_ports UART_A_TX] [get_bd_pins UART_A/sout]
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports SPI_A_MOSI] [get_bd_pins SPI_A/io0_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports SPI_A_CS] [get_bd_pins SPI_A/ss_o]
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports DRDY_A2] [get_bd_pins DRDY_A_GPIO/gpio2_io_i]
  connect_bd_net -net gpio_io_i_0_1 [get_bd_ports DRDY_A1] [get_bd_pins DRDY_A_GPIO/gpio_io_i]
  connect_bd_net -net io1_i_0_1 [get_bd_ports SPI_A_MISO] [get_bd_pins SPI_A/io1_i]
  connect_bd_net -net io1_i_0_2 [get_bd_ports SPI_FLASH_A_DQ1] [get_bd_pins SPI_FLASH_A/io1_i]
  connect_bd_net -net io3_i_0_1 [get_bd_ports SPI_FLASH_A_DQ3] [get_bd_pins SPI_FLASH_A/io3_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DRDY_A_GPIO/s_axi_aclk] [get_bd_pins GPIO_DataEnable/s_axi_aclk] [get_bd_pins SPI_A/s_axi_aclk] [get_bd_pins SPI_FLASH_A/s_axi_aclk] [get_bd_pins UART_3/s_axi_aclk] [get_bd_pins UART_4/s_axi_aclk] [get_bd_pins UART_5/s_axi_aclk] [get_bd_pins UART_6/s_axi_aclk] [get_bd_pins UART_7/s_axi_aclk] [get_bd_pins UART_8/s_axi_aclk] [get_bd_pins UART_A/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins UART_3/xin] [get_bd_pins UART_4/xin] [get_bd_pins UART_5/xin] [get_bd_pins UART_6/xin] [get_bd_pins UART_7/xin] [get_bd_pins UART_8/xin] [get_bd_pins UART_A/xin] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports ext_spi_clk_o] [get_bd_pins SPI_A/ext_spi_clk] [get_bd_pins SPI_FLASH_A/ext_spi_clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DRDY_A_GPIO/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GPIO_DataEnable/S_AXI/Reg] -force
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SPI_A/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x41E10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SPI_FLASH_A/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_5/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_6/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_7/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C60000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_8/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_A/S_AXI/Reg] -force
