...
################################################################
# This is a generated script based on design: Zedboard_BD
#
...
if { $list_projs eq "" } {
   create_project $proj_name $proj_dir/$proj_name/workspace -part xc7z020clg484-1
...
add_files -fileset constrs_1 "$proj_dir/$proj_name/constr/zedboard_constraints.xdc"
#set_property target_constrs_file "$proj_dir/$proj_name/constr/zedboard_constraints.xdc" [current_fileset -constrset]
