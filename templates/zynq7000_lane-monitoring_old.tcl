...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M13_AXI [get_bd_intf_pins UART_B/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M13_AXI]
  ...
  connect_bd_net -net sin_0_13 [get_bd_ports UART_B_RX] [get_bd_pins UART_B/sin]
  ...
  assign_bd_address -offset 0x43CC0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_B/S_AXI/Reg] -force
