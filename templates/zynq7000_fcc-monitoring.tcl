...
proc create_root_design { parentCell } {
  ...
  set DataEnable_GPIO [ create_bd_port -dir O -from 7 -to 0 DataEnable_GPIO ]
...
add_files -fileset constrs_1 "$proj_dir/$proj_name/constr/constraints_fcc-monitoring.xdc"
set_property target_constrs_file "$proj_dir/$proj_name/constr/constraints_fcc-monitoring.xdc" [current_fileset -constrset]

# add LED_Driver_FCC_Monitoring.vhd file to project
add_files -norecurse "$proj_dir/$proj_name/hdl/LED_Driver_FCC_Monitoring.vhd"
update_compile_order -fileset sources_1
...
create_bd_cell -type module -reference LED_Driver_FCC_Monitoring LED_Driver_FCC_Monitoring

# create ports
startgroup
make_bd_pins_external  [get_bd_pins LED_Driver_FCC_Monitoring/LED21_i]
make_bd_pins_external  [get_bd_pins LED_Driver_FCC_Monitoring/LED21_o]
make_bd_pins_external  [get_bd_pins LED_Driver_FCC_Monitoring/LED22_i]
make_bd_pins_external  [get_bd_pins LED_Driver_FCC_Monitoring/LED22_o]
endgroup
