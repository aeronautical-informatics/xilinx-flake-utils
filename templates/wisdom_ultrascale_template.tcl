...
if { $list_projs eq "" } {
create_project $proj_name $proj_dir/$proj_name/workspace -part xczu3eg-sfvc784-1-e
...
proc create_root_design { parentCell } {
  ...
  set Data_Enable [ create_bd_port -dir O -from 7 -to 0 Data_Enable ]
  #set LED_1_IN [ create_bd_port -dir I LED_1_IN ]
  #set LED_1_OUT [ create_bd_port -dir O LED_1_OUT ]
  #set LED_2_IN [ create_bd_port -dir I LED_2_IN ]
  #set LED_2_OUT [ create_bd_port -dir O LED_2_OUT ]
  ...
  # Create instance: Data_Enable, and set properties
  set Data_Enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Data_Enable ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {8} \
 ] $Data_Enable

  # Create instance: Interrupt_Multiplexer, and set properties
  set Interrupt_Multiplexer [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 Interrupt_Multiplexer ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $Interrupt_Multiplexer
  ...
  # Create instance: UART_2, and set properties
  set UART_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 UART_2 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins UART_1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins UART_2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins UART_3/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins UART_4/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins UART_5/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins UART_6/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins UART_7/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins UART_8/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins Data_Enable/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net Data_Enable_gpio_io_o [get_bd_ports Data_Enable] [get_bd_pins Data_Enable/gpio_io_o]
  connect_bd_net -net Interrupt_Multiplexer_dout [get_bd_pins Interrupt_Multiplexer/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  #connect_bd_net -net LED_1_i_0_1 [get_bd_ports LED_1_IN] [get_bd_pins LED_Driver/LED_1_i]
  #connect_bd_net -net LED_2_i_0_1 [get_bd_ports LED_2_IN] [get_bd_pins LED_Driver/LED_2_i]
  #connect_bd_net -net LED_Driver_0_LED_1_o [get_bd_ports LED_1_OUT] [get_bd_pins LED_Driver/LED_1_o]
  #connect_bd_net -net LED_Driver_0_LED_2_o [get_bd_ports LED_2_OUT] [get_bd_pins LED_Driver/LED_2_o]
  connect_bd_net -net UART_1_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In0] [get_bd_pins UART_1/ip2intc_irpt]
  connect_bd_net -net UART_1_sout [get_bd_ports UART_1_TX] [get_bd_pins UART_1/sout]
  connect_bd_net -net UART_2_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In1] [get_bd_pins UART_2/ip2intc_irpt]
  connect_bd_net -net UART_2_sout [get_bd_ports UART_2_TX] [get_bd_pins UART_2/sout]
  connect_bd_net -net UART_3_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In2] [get_bd_pins UART_3/ip2intc_irpt]
  connect_bd_net -net UART_3_sout [get_bd_ports UART_3_TX] [get_bd_pins UART_3/sout]
  connect_bd_net -net UART_4_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In3] [get_bd_pins UART_4/ip2intc_irpt]
  connect_bd_net -net UART_4_sout [get_bd_ports UART_4_TX] [get_bd_pins UART_4/sout]
  connect_bd_net -net UART_5_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In4] [get_bd_pins UART_5/ip2intc_irpt]
  connect_bd_net -net UART_5_sout [get_bd_ports UART_5_TX] [get_bd_pins UART_5/sout]
  connect_bd_net -net UART_6_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In5] [get_bd_pins UART_6/ip2intc_irpt]
  connect_bd_net -net UART_6_sout [get_bd_ports UART_6_TX] [get_bd_pins UART_6/sout]
  connect_bd_net -net UART_7_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In6] [get_bd_pins UART_7/ip2intc_irpt]
  connect_bd_net -net UART_7_sout [get_bd_ports UART_7_TX] [get_bd_pins UART_7/sout]
  connect_bd_net -net UART_8_ip2intc_irpt [get_bd_pins Interrupt_Multiplexer/In7] [get_bd_pins UART_8/ip2intc_irpt]
  connect_bd_net -net UART_8_sout [get_bd_ports UART_8_TX] [get_bd_pins UART_8/sout]
  connect_bd_net -net emio_can0_phy_rx_0_1 [get_bd_ports CAN_0_RX] [get_bd_pins zynq_ultra_ps_e_0/emio_can0_phy_rx]
  connect_bd_net -net emio_can1_phy_rx_0_1 [get_bd_ports CAN_1_RX] [get_bd_pins zynq_ultra_ps_e_0/emio_can1_phy_rx]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins Data_Enable/s_axi_aresetn] [get_bd_pins UART_1/s_axi_aresetn] [get_bd_pins UART_2/s_axi_aresetn] [get_bd_pins UART_3/s_axi_aresetn] [get_bd_pins UART_4/s_axi_aresetn] [get_bd_pins UART_5/s_axi_aresetn] [get_bd_pins UART_6/s_axi_aresetn] [get_bd_pins UART_7/s_axi_aresetn] [get_bd_pins UART_8/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net sin_0_1 [get_bd_ports UART_1_RX] [get_bd_pins UART_1/sin]
  connect_bd_net -net sin_0_2 [get_bd_ports UART_2_RX] [get_bd_pins UART_2/sin]
  connect_bd_net -net sin_1_1 [get_bd_ports UART_3_RX] [get_bd_pins UART_3/sin]
  connect_bd_net -net sin_2_1 [get_bd_ports UART_4_RX] [get_bd_pins UART_4/sin]
  connect_bd_net -net sin_3_1 [get_bd_ports UART_5_RX] [get_bd_pins UART_5/sin]
  connect_bd_net -net sin_4_1 [get_bd_ports UART_6_RX] [get_bd_pins UART_6/sin]
  connect_bd_net -net sin_5_1 [get_bd_ports UART_7_RX] [get_bd_pins UART_7/sin]
  connect_bd_net -net sin_6_1 [get_bd_ports UART_8_RX] [get_bd_pins UART_8/sin]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_can0_phy_tx [get_bd_ports CAN_0_TX] [get_bd_pins zynq_ultra_ps_e_0/emio_can0_phy_tx]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_can1_phy_tx [get_bd_ports CAN_1_TX] [get_bd_pins zynq_ultra_ps_e_0/emio_can1_phy_tx]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins Data_Enable/s_axi_aclk] [get_bd_pins UART_1/s_axi_aclk] [get_bd_pins UART_2/s_axi_aclk] [get_bd_pins UART_3/s_axi_aclk] [get_bd_pins UART_4/s_axi_aclk] [get_bd_pins UART_5/s_axi_aclk] [get_bd_pins UART_6/s_axi_aclk] [get_bd_pins UART_7/s_axi_aclk] [get_bd_pins UART_8/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_3/S_AXI/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_4/S_AXI/Reg] -force
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_5/S_AXI/Reg] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_6/S_AXI/Reg] -force
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_7/S_AXI/Reg] -force
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_8/S_AXI/Reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Data_Enable/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UART_1/S_AXI/Reg] -force
